...
function refactorTable(filePath) {
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="bg-zinc-50/50 dark:bg-zinc-800/50 border-b border-zinc-200 dark:border-zinc-700 text-left text-zinc-500 dark:text-zinc-400">
                            ...
                            <th className="py-2.5 px-4 font-semibold text-center w-40">코스 기입</th>
...
refactorTable(path.join(__dirname, 'src/components/courseInfo/CourseInfoTable.tsx'));
