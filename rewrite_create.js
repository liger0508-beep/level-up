...
function replaceInCreate(filePath) {
    let content = fs.readFileSync(filePath, 'utf-8');
    
    // Completely replace the file content with the new React component
        ...
        <div className="min-h-screen bg-white dark:bg-zinc-950 px-4 sm:px-8 py-6">
            <div className="max-w-3xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 pb-20">
                    ...
                    <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-6 rounded-3xl shadow-sm space-y-4">
                        <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300 flex items-center gap-2 mb-2">
                            <Layout size={18} className="text-zinc-400" />
                            홀별 추가 정보 기입
                        </label>
                        <div className="space-y-3">
...
replaceInCreate(path.join(__dirname, 'src/app/(main)/course-info/create/page.tsx'));
console.log("Create page rewritten.");
