...
type RankingCategory = "shot" | "around_green" | "putting";

function RankingsContent() {
    const router = useRouter();
    const searchParams = useSearchParams();
    const initialCategory = (searchParams.get("category") as RankingCategory) || "shot";
    ...
    useEffect(() => {
        ...
        if (cat && ["shot", "around_green", "putting"].includes(cat)) {
            ...
            <div className="max-w-xl mx-auto p-4 space-y-6">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                    {[
                        ...
                        { key: "around_green", label: "숏게임", icon: <Flag size={14} /> },
