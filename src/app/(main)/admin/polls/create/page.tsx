...
export default function CreateVotePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert(`투표 등록에 실패했습니다: ${error.message || "다시 시도해 주세요"}`);
        } finally {
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 pb-20">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-6 border-t border-zinc-200 dark:border-zinc-800">
                        ...
                        <button
                            type="submit"
                            className="bg-brand-navy hover:bg-brand-navy-dark text-white px-10 py-3 rounded-2xl text-sm font-bold transition-all shadow-md active:scale-95 flex items-center gap-2 disabled:opacity-50 disabled:active:scale-100"
                            disabled={isSubmitting}
                        >
                            {isSubmitting ? (
