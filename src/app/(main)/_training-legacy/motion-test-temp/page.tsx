...
import { Play, Square, Mic, MicOff, CheckCircle, ChevronLeft, ChevronRight, Lock, Unlock, Pause, Volume2, Check } from "lucide-react";
    ...
    stages: [
      {
        stageNum: 1,
        target: 7,
        introPrompt: "목표는 빈스윙과 같은 스피드로 7개 치기입니다. 공을 친 후 이어폰 버튼이나 화면의 성공을 눌러주세요.",
    ...
    stages: [
      {
        stageNum: 1,
        target: 3,
        introPrompt: "1번홀 티샷 목표는 페어웨이 3회 적중입니다. 페어웨이라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "페어웨이 3회 적중",
        nextStagePrompt: "다음 티샷 정확도 복습홀은 2번홀 입니다. 티샷 목표는 페어웨이 2회 적중입니다. 페어웨이라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 2,
        introPrompt: "티샷 목표는 페어웨이 2회 적중입니다. 페어웨이라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "페어웨이 2회 적중"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "1번홀 185미터 지점 입니다. 목표는 7미터 이내로 4개 적중 시키기. 7미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "7미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 2번홀 185미터 지점 입니다. 목표는 7미터 이내로 4개 적중 시키기. 7미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
        introPrompt: "목표는 7미터 이내로 4개 적중 시키기. 7미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "7미터 이내로 4개 적중 시키기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "3번홀 130미터 지점 입니다. 목표는 5미터 이내로 4개 적중 시키기. 5미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "5미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 4번홀 140미터 지점 입니다. 목표는 5미터 이내로 4개 적중 시키기. 5미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
        introPrompt: "목표는 5미터 이내로 4개 적중 시키기. 5미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "5미터 이내로 4개 적중 시키기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "5번홀 100미터 지점 입니다. 목표는 4미터 이내로 4개 적중 시키기. 4미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "4미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 6번홀 110미터 지점 입니다. 목표는 4미터 이내로 4개 적중 시키기. 4미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
        introPrompt: "목표는 4미터 이내로 4개 적중 시키기. 4미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "4미터 이내로 4개 적중 시키기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "7번홀 50미터 지점 입니다. 목표는 3미터 이내로 4개 적중 시키기. 3미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "3미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 8번홀 60미터 지점 입니다. 목표는 3미터 이내로 4개 적중 시키기. 3미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
        introPrompt: "목표는 3미터 이내로 4개 적중 시키기. 3미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "3미터 이내로 4개 적중 시키기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "1번홀 벙커 지점 입니다. 목표는 3미터 이내로 4개 적중 시키기. 3미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "3미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 2번홀 벙커 지점 입니다. 목표는 3미터 이내로 4개 적중 시키기. 3미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "3번홀 20미터 지점 입니다. 목표는 2미터 이내로 4개 적중 시키기. 2미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "2미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 4번홀 15미터 지점 입니다. 목표는 2미터 이내로 4개 적중 시키기. 2미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
        introPrompt: "목표는 2미터 이내로 4개 적중 시키기. 2미터 이내 라고 생각되면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "2미터 이내로 4개 적중 시키기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 4,
        introPrompt: "1번홀 10미터 지점 입니다. 목표는 1미터 이내로 4개 적중 시키기. 1미터 이내로 붙으면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "1미터 이내로 4개 적중 시키기",
        nextStagePrompt: "다음 복습홀은 2번홀 12미터 지점 입니다. 목표는 1미터 이내로 4개 적중 시키기. 1미터 이내로 붙으면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 4,
        introPrompt: "목표는 1미터 이내로 4개 적중 시키기. 1미터 이내로 붙으면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "1미터 이내로 4개 적중 시키기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 2,
        introPrompt: "3번홀 5미터 지점 입니다. 목표는 원퍼트 2개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "원퍼트 2개 하기",
        nextStagePrompt: "다음 복습홀은 4번홀 6미터 지점 입니다. 목표는 원퍼트 2개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 2,
        introPrompt: "목표는 원퍼트 2개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "원퍼트 2개 하기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 5,
        introPrompt: "5번홀 2미터 지점 입니다. 목표는 원퍼트 5개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "원퍼트 5개 하기",
        nextStagePrompt: "다음 복습홀은 6번홀 3미터 지점 입니다. 목표는 원퍼트 5개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 5,
        introPrompt: "목표는 원퍼트 5개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "원퍼트 5개 하기"
      }
    ],
    ...
    stages: [
      {
        stageNum: 1,
        target: 6,
        introPrompt: "7번홀 1미터 지점 입니다. 목표는 원퍼트 6개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "원퍼트 6개 하기",
        nextStagePrompt: "다음 복습홀은 8번홀 1미터 지점 입니다. 목표는 원퍼트 6개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요."
      },
      {
        stageNum: 2,
        target: 6,
        introPrompt: "목표는 원퍼트 6개 하기 입니다. 원퍼트를 하면 이어폰 버튼이나 화면의 성공을 눌러주세요.",
        goalDesc: "원퍼트 6개 하기"
      }
    ],
...
function VoiceReviewContent() {
  ...
  const parsedHoles = reviewHolesParam ? JSON.parse(reviewHolesParam) : [];
  ...
  const [time, setTime] = useState(174); // 2:54
  ...
  const addLog = (msg: string) => setDebugLogs(prev => [...prev, msg].slice(-5));
  ...
  const generatePrompt = (holeNum: string|number, attemptLabel: string, par: number) => {
       ...
       const parString = par === 5 ? "five" : par === 4 ? "four" : par === 3 ? "three" : par;
       ...
       if (isPrep) {
           ...
           if (reviewCat === "티샷" || reviewCat === "티샷 비거리" || reviewCat === "티샷 정확도") {
               return `${holeText}번홀 par ${parString} 티샷입니다. 티샷 후 이어폰 버튼을 눌러주세요.`;
           } else if (cleanAttempt.startsWith("TE") || cleanAttempt.startsWith("티박스")) {
               const match = cleanAttempt.match(/\d+/);
               const dist = match ? match[0] : "";
               return `${holeText}번홀 par three 티박스, 홀까지 거리 ${dist}m 입니다.`;
           } else {
               const match = cleanAttempt.match(/\d+/);
               const dist = match ? match[0] : "";
               
               if (shouldHideHole) {
                   const isBunkerOrApproach = reviewCat?.includes("벙커") || reviewCat?.includes("어프로치");
                   const isPutt = ["9m", "4-8", "2-3", "1m"].some(c => reviewCat?.toLowerCase().includes(c));
                   
                   if (isBunkerOrApproach && dist) {
                       const pinPositions = ["앞핀", "뒷핀", "심한 오르막", "심한 내리막"];
                       const randomPin = pinPositions[Math.floor(Math.random() * pinPositions.length)];
                       return `시도 위치는 ${dist}미터, 핀위치는 ${randomPin} 입니다.`;
                   }
                   
                   if (isPutt && dist) {
                       const slopes = ["슬라이스", "훅", "오르막", "내리막", "스트레이트"];
                       const randomSlope = slopes[Math.floor(Math.random() * slopes.length)];
                       return `시도 위치는 ${dist}미터, ${randomSlope} 경사 입니다.`;
                   }
                   
                   return dist ? `홀까지 거리 ${dist}m 입니다.` : `${reviewCat} 훈련입니다.`;
               }
               
               return dist ? `${holeText}번홀, 홀까지 거리 ${dist}m 입니다.` : `${holeText}번홀 훈련입니다.`;
           }
       } else {
           return `${holeText}번홀 ${cleanAttempt} 지점입니다. 목표는 ${goalTextForReview}입니다.`;
       }
  };
  ...
  }, [reviewType, reviewCat, reviewHole, reviewAttempt]);
  ...
  const speakAndWait = (text: string, callback?: () => void) => {
    ...
    const finishSpeech = () => {
        ...
        setVoiceState(prev => ({ ...prev, statusText: '샷 결과 대기 중 (이어폰 버튼)' }));
                     ...
                     try {
                         ...
                         if (chainStr) {
                             ...
                             if (currentIndexInChain !== -1 && currentIndexInChain + 1 < chain.length) {
                                 ...
                                 speakAndWait(`해당 훈련을 완료하였습니다. 다음 ${nextCat.catName} 훈련도 이어서 진행하시겠습니까?`);
                                 return;
                             }
                         }
                     } catch (e) {
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100dvh-70px)] bg-[#F8F9FC] dark:bg-zinc-950 p-6">
        <div className="w-full max-w-sm bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 shadow-sm border border-zinc-200/60 dark:border-zinc-800/60 flex flex-col gap-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            <h1 className="text-2xl font-black text-zinc-900 dark:text-zinc-50 tracking-tight">복습 음성 (임시 - 이어폰)</h1>
          </div>
  ...
  const currentHoleData = (trainingType === 'review_category' || trainingType === 'review_hole') 
    ? (trainingType === 'review_category' ? parsedHoles[Math.min(stageIndex, parsedHoles.length - 1)] : { hole: reviewHole, attempt: reviewAttempt, result: reviewResult, score: reviewScore, note: reviewNote })
    : null;

  return (
    <div 
      className="flex flex-col items-center justify-center min-h-[calc(100dvh-70px)] bg-zinc-50 dark:bg-zinc-950 p-4 relative select-none"
      onClick={handleScreenDoubleTap}
    >
       <div className="w-full max-w-md flex flex-col items-center text-center relative">
           
           {/* Main Info Box */}
           <div className="w-full bg-white dark:bg-zinc-900 rounded-[1.5rem] p-6 shadow-sm mb-4 border border-zinc-100 dark:border-zinc-800">
               {/* Title */}
               <div className="flex mb-8">
                   <div className="flex items-center px-4 py-2 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-[#F8F9FC] dark:bg-zinc-800 shadow-sm w-fit">
                       <h2 className="text-[15px] font-bold text-zinc-700 dark:text-zinc-300">
                           {currentHoleData?.hole || 1}번홀 · Par {currentHoleData?.par || 5}
                       </h2>
                   </div>
               </div>
               ...
               <div className="flex flex-col gap-5 text-left">
                   {/* 시도 */}
                   <div className="flex items-center border-b border-zinc-100 dark:border-zinc-800 pb-5">
                       <div className="w-1.5 h-4 bg-zinc-300 dark:bg-zinc-600 rounded-full mr-4"></div>
                       <span className="text-zinc-500 font-bold w-12 text-base">시도</span>
                       <span className="font-bold text-zinc-900 dark:text-zinc-100 ml-4 text-base">{currentHoleData?.attempt || '그린 / 14m'}</span>
                   </div>
                   {/* 결과 */}
                   <div className="flex items-center border-b border-zinc-100 dark:border-zinc-800 pb-5">
                       <div className="w-1.5 h-4 bg-rose-500 rounded-full mr-4"></div>
                       <span className="text-zinc-500 font-bold w-12 text-base">결과</span>
                       <span className="font-bold text-zinc-900 dark:text-zinc-100 ml-4 text-base">{currentHoleData?.result || '그린 / 2m'}</span>
                   </div>
                   {/* 시간 */}
                   <div className="flex items-center pt-1">
                       <div className="w-1.5 h-6 bg-blue-500 rounded-full mr-4"></div>
                       <span className="text-zinc-900 dark:text-zinc-100 font-bold w-12 text-lg">시간</span>
                       <div className="flex items-center gap-3 ml-4 flex-1">
                           <span className="font-black text-2xl text-zinc-900 dark:text-zinc-100 tracking-wider">
                               {Math.floor(time / 60)} : {String(time % 60).padStart(2, '0')}
                           </span>
                           <div className="flex gap-2 ml-auto">
                               <button 
                                   onClick={(e) => { e.stopPropagation(); setTime(t => Math.max(0, t - 10)); }} 
                                   className="w-12 h-10 rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 flex items-center justify-center text-sm font-bold text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700"
                               >
                                   -10
                               </button>
                               <button 
                                   onClick={(e) => { e.stopPropagation(); setTime(t => t + 10); }} 
                                   className="w-12 h-10 rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 flex items-center justify-center text-sm font-bold text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-700"
                               >
                                   +10
                               </button>
           ...
           {/* Actions Box */}
           <div className="w-full bg-white dark:bg-zinc-900 rounded-[1.5rem] p-6 shadow-sm flex flex-col gap-6 border border-zinc-100 dark:border-zinc-800">
               <div className="flex justify-between items-center px-1">
                   <button onClick={(e) => { e.stopPropagation(); togglePause(); }} className="flex flex-col items-center gap-2 group">
                       <div className="w-16 h-16 bg-zinc-900 dark:bg-white rounded-[1.2rem] flex items-center justify-center shadow-md group-hover:scale-95 transition-transform">
                           <Play className="w-7 h-7 text-white dark:text-zinc-900 fill-white dark:fill-zinc-900" />
                       </div>
                       <span className="text-[12px] font-bold text-zinc-600 dark:text-zinc-400">재개</span>
                   </button>
                   <button onClick={(e) => { e.stopPropagation(); speakAndWait(currentConfig?.stages[0]?.introPrompt || '다시 듣기'); }} className="flex flex-col items-center gap-2 group">
                       <div className="w-16 h-16 bg-white dark:bg-zinc-800 border-2 border-zinc-100 dark:border-zinc-700 rounded-[1.2rem] flex items-center justify-center shadow-sm group-hover:scale-95 transition-transform">
                           <Volume2 className="w-7 h-7 text-zinc-700 dark:text-zinc-300" />
                       </div>
                       <span className="text-[12px] font-bold text-zinc-600 dark:text-zinc-400">듣기</span>
                   </button>
                   <button onClick={(e) => { e.stopPropagation(); handleShotSuccess(); }} className="flex flex-col items-center gap-2 group">
                       <div className="w-16 h-16 bg-blue-600 rounded-[1.2rem] flex items-center justify-center shadow-md group-hover:scale-95 transition-transform">
                           <Check className="w-7 h-7 text-white" strokeWidth={3} />
                       </div>
                       <span className="text-[12px] font-bold text-blue-500">완료</span>
                   </button>
                   <button onClick={(e) => { e.stopPropagation(); stopTraining(); }} className="flex flex-col items-center gap-2 group">
                       <div className="w-16 h-16 bg-rose-50 dark:bg-rose-500/10 border-2 border-rose-100 dark:border-rose-500/20 rounded-[1.2rem] flex items-center justify-center shadow-sm group-hover:scale-95 transition-transform">
               ...
               <div className="flex gap-3 mt-2">
                   <button 
                       onClick={(e) => { e.stopPropagation(); setStageIndex(Math.max(0, stageIndex - 1)); }}
                       className="flex-1 py-3.5 rounded-xl border-2 border-zinc-100 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 font-bold flex items-center justify-center gap-1 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                   >
                       <ChevronLeft className="w-5 h-5" /> 이전
                   </button>
                   <button 
                       onClick={(e) => { e.stopPropagation(); handleShotSuccess(); }}
                       className="flex-1 py-3.5 rounded-xl border-2 border-zinc-100 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 font-bold flex items-center justify-center gap-1 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                   >
           ...
           {/* Debug Logs Overlay */}
           {debugLogs.length > 0 && (
             <div className="w-full mt-4 bg-black/80 rounded-xl p-3 text-left">
               <div className="text-[10px] text-green-400 font-mono mb-1">시스템 상태 모니터:</div>
               {debugLogs.map((log, i) => (
                 <div key={i} className="text-xs text-white font-mono">{log}</div>
               ))}
             </div>
           )}
