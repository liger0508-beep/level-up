...
export default function CommunityPage() {
    ...
    // Filtered notices for the main list
    const filteredNotices = useMemo(() => {
        return notices.filter((n) => {
            const typeMatch = activeType === "all" || n.type === activeType || n.type === "all";
    ...
    }, [notices, activeType, searchQuery, startDate, endDate]);

    // Recent 3 notices for the top carousel
                        ...
                        {recentNotices.map((notice) => (
                            ...
                            >
                                ...
                                <div className="text-[11px] text-zinc-400 font-medium flex items-center justify-end gap-2 mt-auto pt-2 border-t border-zinc-50 dark:border-zinc-800/50">
                                    ...
                                    <span>{notice.date.replace(/-/g, ".")}</span>
                                </div>
                            </Link>
                        ))}
                    </div>
                        ...
                        <>
                            ...
                            {filteredNotices.length > displayLimit && (
                                <div className="mt-8 flex justify-center">
                                    ...
                                    >
                                        더 보기 ({filteredNotices.length - displayLimit}건 남음)
                                    </button>
                                </div>
                            )}
                        </>
