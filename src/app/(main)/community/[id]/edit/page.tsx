...
import { getNoticeById, updateNotice, NOTICE_TYPE_LABELS, NoticeType, NOTICE_TYPE_COLORS, Notice } from "@/lib/notice-sync";
...
export default function EditNoticePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await updateNotice(id as string, {
                type,
                branch,
                title,
                content,
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-4">
                <p className="text-zinc-500 mb-4 animate-pulse">로딩 중...</p>
            </div>
        );
    }
